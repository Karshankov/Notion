...
import { ChevronsLeft, LogOut, MenuIcon, Plus, PlusCircle, Search, Settings, Trash } from "lucide-react"
...
return (
    ...
    ref={sidebarRef}>
      <div>
        ...
        <div >
            <Link href="http://localhost:3000/" className="mt-5">
        ...
        <div>
          ...
          <Item onClick={handleCreate} label='Новая страница' icon={PlusCircle}/>
        </div>
        <div className="mt-4">
          <DocumentList/>
